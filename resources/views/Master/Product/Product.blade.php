  ...
  <div role="document" class="modal-dialog modal-sm">
	<div class="modal-content" >
	  ...
	  <div class="modal-body">
	 	 <h4>Are You Sure To Add This Data?</h4> <br> </h5>I adivse you to change the "Product Status" rather than delete it</h5>
	  </div>
	  <div class="modal-footer" >
	  	<center>
		<a href="ProductDestroy/{{ $pr->PRODUCT_ID }}"><button type="submit" class="btn btn-danger">Yes</button></a>
		<a href="ProductEdit{{ $pr->PRODUCT_ID }}" class="btn btn-success" >Change Status</a>
