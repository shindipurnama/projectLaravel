	...
	<div class="container-fluid d-flex align-items-center justify-content-between">
	  <div class="navbar-header">
		<!-- Navbar Header--><a href="index.html" class="navbar-brand">
		  <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Project</strong><strong>Admin</strong></div>
	  ...
	  <div class="right-menu list-inline no-margin-bottom">    
		...
		<!-- Log out               -->
		<div class="list-inline-item logout">                   <a id="logout" href="login" class="nav-link"> <span class="d-none d-sm-inline">Logout </span><i class="icon-logout"></i></a></div>
	  </div>
	</div>
  </nav>
</header>
